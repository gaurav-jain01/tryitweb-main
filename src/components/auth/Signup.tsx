    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-bg-primary p-5 transition-colors duration-300">
        <div className="bg-bg-secondary border border-border-color rounded-2xl p-10 w-full max-w-md shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
          ...
          <div className="bg-success/10 border border-success/20 text-success p-4 rounded-lg text-sm font-medium text-center">
            <p className="mb-2">Redirecting to login page in 3 seconds...</p>
      ...
      <div className="bg-bg-secondary border border-border-color rounded-2xl p-10 w-full max-w-md shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2 min-h-[85px]">
            <label htmlFor="name" className="text-text-primary text-sm font-semibold">
              Full Name
            </label>
            <input
              type="text"
              ...
              className={`w-full h-12 px-4 border-2 border-border-color rounded-lg text-base bg-bg-primary text-text-primary transition-all duration-300 font-inherit focus:outline-none focus:border-accent-primary focus:ring-3 focus:ring-accent-primary ${
                errors.name ? 'border-danger ring-danger' : ''
              }`}
          ...
          <div className="space-y-2 min-h-[85px]">
            <label htmlFor="confirmPassword" className="text-text-primary text-sm font-semibold">
              Confirm Password
            </label>
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full h-12 px-4 pr-12 border-2 border-border-color rounded-lg text-base bg-bg-primary text-text-primary transition-all duration-300 font-inherit focus:outline-none focus:border-accent-primary focus:ring-3 focus:ring-accent-primary ${
                  errors.confirmPassword ? 'border-danger ring-danger' : ''
                }`}
        ...
        <div className="text-center mt-6 pt-6 border-t border-border-color">
          <p className="text-text-secondary text-sm">
            ...
            <Link to="/login" className="text-accent-primary font-semibold transition-colors duration-300 hover:text-accent-secondary hover:underline">
              Sign in
            </Link>
          </p>
        </div>
